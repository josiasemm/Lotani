...
```bash
git clone [https://github.com/josiasemm/lotani.git](https://github.com/josiasemm/lotani.git)
cd lotani
...
Crea un archivo .env.local en la raíz del proyecto tomando como base las credenciales de tus servicios (puedes usar el archivo .env.example como plantilla):
